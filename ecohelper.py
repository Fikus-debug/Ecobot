...
@bot.message_handler(commands=['ecologyhelp'])
def send_welcome(message):
        bot.reply_to(message, "Вот некоторые примеры решения экологисческих проблем:Регулирование промышленных выбросов,Развитие возобновляемой энергетики,Введение строгих норм по сбросу сточных вод,Создание очистных сооружений,Переработка отходов,Переход на возобновляемые источники энергии,Внедрение систем торговли выбросами углекислого газа")
